    ...
    >
      <div className="mx-auto flex w-full max-w-[1440px] flex-col items-center justify-between gap-8 py-12 md:flex-row md:gap-0 md:px-8 md:py-0 lg:px-0">
        ...
        <motion.header
          ...
          initial="hidden"
          animate="visible"
          className="absolute inset-x-0 bottom-0 z-10 flex w-full items-center bg-gradient-to-t from-[var(--bg-color)] via-[var(--bg-color)]/95 to-[var(--bg-color)]/0 px-6 pb-10 pt-8 backdrop-blur-[2px] md:relative md:inset-auto md:order-1 md:h-[72vh] md:w-[54%] md:bg-[var(--bg-color)] md:px-0 md:pr-6 md:py-0 md:backdrop-blur-none lg:h-screen lg:w-1/2 lg:pr-0 lg:px-12"
        >
          <div className="w-full max-w-lg py-4 md:max-w-[560px] lg:max-w-[680px]">
            <motion.p
              variants={itemVariants}
              className="text-[10px] font-medium tracking-[0.18em] text-[var(--accent-color)] sm:text-xs md:text-xs lg:text-base"
            >
            ...
            >
              ...
              <a
                href="#contact"
                className="group relative inline-flex flex-1 items-center justify-center gap-1.5 overflow-hidden rounded-full bg-[var(--accent-color)] px-3 py-2.5 text-xs font-medium text-white transition-all duration-500 hover:scale-[1.02] sm:flex-initial sm:gap-3 sm:px-8 sm:py-4 sm:text-base md:px-6 md:py-3.5 md:text-sm lg:px-8 lg:py-4 lg:text-base"
              >
                <span
                  aria-hidden="true"
